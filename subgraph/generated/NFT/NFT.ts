...
export class MarketItemSale extends ethereum.Event {
  get params(): MarketItemSale__Params {
    return new MarketItemSale__Params(this);
  }
}

export class MarketItemSale__Params {
  _event: MarketItemSale;

  constructor(event: MarketItemSale) {
    this._event = event;
  }
...
export class NFT__marketItemsResult {
  value0: Address;
  value1: BigInt;
  value2: boolean;
...
export class NFT extends ethereum.SmartContract {
  ...
  marketItems(param0: BigInt): NFT__marketItemsResult {
    let result = super.call(
      "marketItems",
      "marketItems(uint256):(address,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new NFT__marketItemsResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBoolean()
    );
  ...
  try_marketItems(param0: BigInt): ethereum.CallResult<NFT__marketItemsResult> {
    let result = super.tryCall(
      "marketItems",
      "marketItems(uint256):(address,uint256,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
